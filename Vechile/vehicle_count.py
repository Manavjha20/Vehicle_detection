...
import collections
import numpy as np
from tracker import EuclideanDistTracker  # Import the tracker class
...
def count_vehicle(box_id, img):
    ...
    elif middle_line_position < iy < down_line_position:
...
def from_static_image(image):
    ...
    # Draw counting texts in the frame
    cv2.putText(img, f"Car:        {frequency['car']}", (20, 40), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, font_thickness)
    cv2.putText(img, f"Motorbike:  {frequency['motorbike']}", (20, 60), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, font_thickness)
    cv2.putText(img, f"Bus:        {frequency['bus']}", (20, 80), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, font_thickness)
    cv2.putText(img, f"Truck:      {frequency['truck']}", (20, 100), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, font_thickness)
...
if __name__ == '__main__':
    realTime()  # To process a video
    # from_static_image(image_file)  # To process a static image